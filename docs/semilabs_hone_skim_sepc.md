...
> **⚠️ UI 规范变更说明 (2026-07-12)**
> 
> **本章已废弃**。UI 实现已全部迁移到独立文档：
> 
> 📄 **`docs/ui_design_spec_v2.md`** — 内容工厂 UI 设计与布局规范 (V2 合并版)
> 
> **技术栈变更**：
> - ~~`Pico CSS`~~ → `Tailwind CDN (暗色科技风)`
> - 所有 UI 组件、布局、交互逻辑均以 `ui_design_spec_v2.md` 为准
> - 本章保留作为历史参考，**新开发请遵循 V2 规范**
> 
> **已实现的 V2 核心功能**：
> - ✅ 四大业务板块侧边栏（素材抓取/素材加工/内容制作/内容运营）
> - ✅ 7 种任务状态徽章（含轮询刷新）
> - ✅ 三色统计卡片（今日抓取量/运行中/异常风控）
> - ✅ 风控接管页（左右分栏 + 暖橙渐变警示区）
> - ✅ 创建任务弹窗（含耗时预估二次确认）
> - ✅ 操作按钮即时刷新（HTMX 轮询 + 点击后刷新）
